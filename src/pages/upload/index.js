          ...
          <div className={styles.newaddinputdiv}>
                ...
                <input className={styles.inputfield} name="author" placeholder="enter project author name"
                  ...
                  >
                    ...
                    <option className={styles.selecttypeoption} value="425px">1 : 1</option>
                    <option className={styles.selecttypeoption} value="500px">9 : 16</option>
                    <option className={styles.selecttypeoption} value="350px">16 : 19</option>
                  </select>
