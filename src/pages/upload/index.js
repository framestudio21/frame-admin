...
const Upload = () => {
  ...
  useEffect(() => {
    ...
    const digitalartUploadDiv = document.getElementById("digitalart-upload-div");
    const aiartUploadDiv = document.getElementById("aiart-upload-div");
    const photographyUploadDiv = document.getElementById("photography-upload-div");
        ...
        <div className={styles.uploadpagemainbody}>
          <div className={styles.uploadsection}>
            <div className={styles.headertext}>project Upload Section</div>
              ...
              <select className={styles.selectsection} id="upload-select">
                <option value="" className={styles.selecttypeoption}>
                  select type
                </option>
                <option value="product" className={styles.selecttypeoption}>product</option>
                <option value="digitalart" className={styles.selecttypeoption}>Digital art</option>
                <option value="aiart" className={styles.selecttypeoption}>ai art</option>
                <option vaule="photography" className={styles.selecttypeoption}>photography</option>
              </select>
            </div>
            ...
            >
              ...
              <div className={styles.mandatoryinputdiv}>
                <div className={styles.divleftside}>
                  ...
                  <label id="graphic" className={styles.text}>select the graphic tag</label>
                  <select
                    id="graphic"
                    name="tag1"
                    className={styles.inputfield}
          ...
          <form className={styles.formdiv} onSubmit={handleSubmit} method="POST" id="digitalart">
          <div className={styles.mandatoryinputdiv}>
                <div className={styles.divleftside}>
                  <label className={styles.text}>the mandatory section</label>
                  <input
          ...
          <div className={styles.newaddinputdiv}>
                ...
                <input className={styles.inputfield} name="author" placeholder="enter project author name"
                    value={formData.author || ""}
                    onChange={handleInputChange} />

                  <label for="imageratio" className={styles.text}>select the image size ratio</label>
                  <select
                    name="imageratio"
                    className={styles.selectsection}
                  >
                    <option className={styles.selecttypeoption} value="">select image ratio type</option>
                    <option className={styles.selecttypeoption} value="425">1 : 1</option>
                    <option className={styles.selecttypeoption} value="500">9 : 16</option>
                    <option className={styles.selecttypeoption} value="350">16 : 19</option>
                  </select>
           ...
           <form className={styles.formdiv} onSubmit={handleSubmit} method="POST" id="aiart">
          <div className={styles.mandatoryinputdiv}>
                <div className={styles.divleftside}>
                  <label className={styles.text}>the mandatory section</label>
                  <input
          ...
          <div className={styles.newaddinputdiv}>
                ...
                <input className={styles.inputfield} name="author" placeholder="enter project author name"
                    value={formData.author || ""}
                    onChange={handleInputChange} />
                    <input className={styles.inputfield} name="website" placeholder="enter ai website name or url"
          ...
          <form className={styles.formdiv} onSubmit={handleSubmit} method="POST" id="photography">
          <div className={styles.mandatoryinputdiv}>
                <div className={styles.divleftside}>
                  <label className={styles.text}>the mandatory section</label>
                  <input
          ...
          <div className={styles.newaddinputdiv}>
                ...
                <input className={styles.inputfield} name="photographer" placeholder="enter photographer name"
                    value={formData.photographer || ""}
                    onChange={handleInputChange} />
                    <input className={styles.inputfield} name="edtitor" placeholder="enter edtitor name"
